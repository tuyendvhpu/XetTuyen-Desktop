...
namespace DataAccess
{
     ...
     class ThongTinXetTuyenService
    {
	 ...
	 protected SqlCommand CreateParameters(ThongTinXetTuyen ThongTinXetTuyen)
        {
            ...
            p = cmd.Parameters.Add(Parameters.SoDKXT);
            p.Value = ThongTinXetTuyen.SoDKXT;
            return cmd;
        }
     #region Parameters
     protected class Parameters
     {
         ...
         public static SqlParameter SoDKXT
         {
             get
             {
                 return new SqlParameter("@SoDKXT", SqlDbType.NVarChar, 50);
             }
         }
