...
namespace BusinessService
{
    ...
    public class HoSoService
    {
        ...
        public string GetSoDKXT(string idNganh, string nam, string KhoDK, int len)
        {
            ...
            cmd.Connection = DbConnection.SqlConnection;
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "proc_t_GenaraSoDKXT";
            ...
            p = cmd.Parameters.Add(new SqlParameter("@KhoiDK", SqlDbType.NVarChar, 20));
            p.Value = KhoDK;


            p = cmd.Parameters.Add(new SqlParameter("@len", SqlDbType.TinyInt, 0));
            p.Value = len;
            ...
            if (dataTable.Rows.Count > 0)
            {
                return dataTable.Rows[0]["SoDKXT"].ToString();
            }
            return string.Empty;
        }
