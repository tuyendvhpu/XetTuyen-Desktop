<%@ Page Language="C#" MasterPageFile="~/MasterHoSo.master" AutoEventWireup="true" CodeFile="StepOneTHPT.aspx.cs" Inherits="StepOne" Title="Haiphong Private University" %>
...
<!--  contentHoSo --><div id="contentHoSo">
		...
		<td id="col11">Hạnh kiểm  &nbsp;  
            ...
            (<a href="<%=ResolveUrl("~/huongdan.html") %>" target="_blank">Tra cứu mã tỉnh, trường</a>)
		</td>
		<td id="col12">&nbsp;  Mã đối tượng ưu tiên &nbsp; <asp:TextBox ID="txtDoiTuong" CssClass="Thongtintxt" maxlength="1" Text="0" runat="server"></asp:TextBox><asp:TextBox ID="txtDoiTuong1" Text="0"  CssClass="Thongtintxt" maxlength="1" runat="server"></asp:TextBox></td>
		</tr>
		</table>
  ...
  <tr>
    ...
    <td style="display:inline;"><asp:CheckBoxList ID="cblHeXeTuyen"  
            RepeatDirection="Horizontal"   RepeatColumns="2" RepeatLayout="Table"  
            runat="server" ondatabound="cblHeXeTuyen_DataBound"><asp:ListItem Value="0">Cao Đẳng</asp:ListItem><asp:ListItem Selected="True" Value="1">Đại học</asp:ListItem></asp:CheckBoxList>
    </td>
  </tr>
</table>
